...
const proModel_1 = __importDefault(require("../model/proModel"));
...
const readPresident = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const read = yield proModel_1.default.find();
...
const createPresident = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (user) {
            ...
            const positioned = yield proModel_1.default.create({
                _id: user._id,
                fullName: user === null || user === void 0 ? void 0 : user.fullName,
                position: "PRO",
                user,
            });
            getUser === null || getUser === void 0 ? void 0 : getUser.pro.push(new mongoose_1.default.Types.ObjectId(positioned._id));
