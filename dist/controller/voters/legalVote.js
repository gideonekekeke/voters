...
const legalVoteModel_1 = __importDefault(require("../../votes/president/legalVoteModel"));
...
const createVote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const getVote = yield legalVoteModel_1.default.findById(req.params.voterID);
        if (!getVote) {
            const vote = yield votersModel_1.default.create({
                user,
                fullName: user === null || user === void 0 ? void 0 : user.fullName,
            });
            yield legalVoteModel_1.default.create({
