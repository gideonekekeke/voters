...
const vicePresidentModel_1 = __importDefault(require("../model/vicePresidentModel"));
...
const readPresident = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const read = yield vicePresidentModel_1.default.find();
...
const createPresident = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (user) {
            ...
            const positioned = yield vicePresidentModel_1.default.create({
                fullName: user === null || user === void 0 ? void 0 : user.fullName,
                position: "Vice-President",
                user,
            });
            getUser === null || getUser === void 0 ? void 0 : getUser.vicePresident.push(new mongoose_1.default.Types.ObjectId(positioned._id));
