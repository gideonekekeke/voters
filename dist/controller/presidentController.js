...
exports.readCandidate = exports.createPresident = exports.readPresidentFromUsers = exports.readPresident = void 0;
const userModel_1 = __importDefault(require("../model/userModel"));
const mongoose_1 = __importDefault(require("mongoose"));
const email_1 = require("../util/email");
const PresidentModel_1 = __importDefault(require("../model/PresidentModel"));
...
const readPresident = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const read = yield PresidentModel_1.default.find();
        console.log(read);
    ...
    try {
        ...
        if (!candidate) {
            if (user) {
                ...
                const positioned = yield PresidentModel_1.default.create({
                    _id: user._id,
                ...
                getUser === null || getUser === void 0 ? void 0 : getUser.president.push(new mongoose_1.default.Types.ObjectId(positioned._id));
...
const readCandidate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const read = yield candidateModel_1.default.find();
