...
const legalModel_1 = __importDefault(require("../model/legalModel"));
...
const readPresident = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const read = yield legalModel_1.default.find();
        return res.json({ message: "Reading all legal Director", data: read });
    }
    catch (error) {
...
const readPresidentFromUsers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return res.json({
            message: "Reading all legal Director Post",
            data: read,
        });
    }
    catch (error) {
...
const createPresident = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (user) {
            ...
            const positioned = yield legalModel_1.default.create({
                // _id: user._id,
            ...
            getUser === null || getUser === void 0 ? void 0 : getUser.legal.push(new mongoose_1.default.Types.ObjectId(positioned._id));
