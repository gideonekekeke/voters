...
const socialSecretaryModel_1 = __importDefault(require("../model/socialSecretaryModel"));
...
const readPresident = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const read = yield socialSecretaryModel_1.default.find();
...
const createPresident = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (user) {
            ...
            const positioned = yield socialSecretaryModel_1.default.create({
                _id: user._id,
                fullName: user === null || user === void 0 ? void 0 : user.fullName,
                position: "Social-Secretary",
                user,
            });
            getUser === null || getUser === void 0 ? void 0 : getUser.socialSecretary.push(new mongoose_1.default.Types.ObjectId(positioned._id));
